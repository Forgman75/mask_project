...
def test_returns_iterator_type(sample_transactions):
...
def test_iterator_can_be_consumed_once(sample_transactions):
...
def test_case_sensitive_currency(sample_transactions, currency):
    ...
    result_lower = list(filter_by_currency(sample_transactions, currency.lower()))
...
def test_malformed_transactions_skip_or_error(malformed_transactions):
    """
...
def test_preserves_transaction_data(sample_transactions):
...
def test_filter_by_currency_with_empty_string(sample_transactions):
...
def test_empty_transactions_list(empty_list):
...
def test_no_matching_currency(all_same_currency):
...
def test_all_same_currency(all_same_currency):
...
def test_single_transaction_match(single_usd_transaction):
...
def test_single_transaction_no_match(single_usd_transaction):
...
def test_with_transaction_data(sample_transactions):
...
def test_missing_description_key(transaction_without_description):
...
def test_iteration_transactions_with_for_loop(sample_transactions, expected_descriptions):
...
def test_description_generator_exhaustion():
...
def test_parametrized_iteration(count):
...
def test_edge_case_maximum():
    ...
    cards = list(card_number_generator(
        9999999999999999, 
        9999999999999999
    ))
